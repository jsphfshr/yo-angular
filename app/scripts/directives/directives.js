...
angular.module('app.directives', ['ui.load'])
            ...
            compile: function(el) {
                ...
                return function(scope, el, attrs) {
                    ...
                    uiLoad.load(MODULE_CONFIG[attrs.uiModule])
                        .then(function() {
                            $compile(contents)(function(clonedElement) {
    ...
    .directive('uiShift', ['$timeout', function($timeout) {
        return {
            ...
            link: function(scope, el, attr) {
                ...
                !prev.length && (parent = _el.parent()); //TODO: Figure out what this does and how to fix lint error
    ...
    .directive('otStatusCircle', function() {
        return {
            restrict: 'EA',
            scope: {
                status: '@status',
            ...
            templateUrl: 'views/app_otstatuscircle.html'
        };
    })
